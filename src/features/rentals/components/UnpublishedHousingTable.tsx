...
export function UnpublishedHousingTable() {
  ...
  const columns = [
    ...
    { key: "preferredMoveOutDate", label: "Ev. tillgänglig", render: (s: any) => s.preferredMoveOutDate ? new Date(s.preferredMoveOutDate).toLocaleDateString('sv-SE') : '-', hideOnMobile: true },
