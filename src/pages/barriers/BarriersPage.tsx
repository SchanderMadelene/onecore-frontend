...
import { BarrierStatisticsView } from "@/features/barriers/components/BarrierStatisticsView";
    ...
    <PageLayout isSidebarOpen={isSidebarOpen} setIsSidebarOpen={setIsSidebarOpen}>
      <div className="space-y-6">
        ...
        <Tabs defaultValue="barriers">
          <TabsList>
            <TabsTrigger value="barriers">Spärrar</TabsTrigger>
            <TabsTrigger value="statistics">Statistik</TabsTrigger>
          </TabsList>

          <TabsContent value="barriers" className="mt-4 space-y-6">
            <Card>
          ...
          <TabsContent value="statistics" className="mt-4">
            <BarrierStatisticsView barriers={allBarriers} />
          </TabsContent>
        </Tabs>
      </div>
    </PageLayout>
