...
export const BuildingEntrances = ({
  ...
  return <div className="space-y-6">
      <h2 className="text-2xl font-bold">Uppgångar/Portar/Adresser?</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {building.entrances.map(entrance => <Card key={entrance.id}>
            ...
            <CardContent>
              ...
              return apartment ? <div key={aptId} className="flex justify-between items-center p-2 rounded-md hover:bg-muted/50 transition-colors">
                      <div>
                    ...
                    </div> : <div key={aptId} className="flex justify-between items-center p-2 rounded-md border border-destructive/30 bg-destructive/5">
                      <div>
